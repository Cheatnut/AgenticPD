...
for branch reuse remains in the ORFS adapter layer.
"""
...
from core.models import CheckpointRef, TrialRecord
...
class CheckpointManager:
    ...
    def load(self, trial: TrialRecord, stage: str,
        ...
        # 1) Per-stage path (checkpoint resolution fix)
    ...
    def _write_checkpoint(trial: TrialRecord, cp: CheckpointRef,
        ...
        Per-stage persistence (checkpoint resolution fix): each stage gets its own file
...
if __name__ == "__main__":
    ...
    # checkpoint resolution fix: per-stage path
